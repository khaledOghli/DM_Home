...
!(function (t, e) {
        ...
        return (
            ...
            function (t, e, r) {
                ...
                if (!p) {
                    ...
                    for (p = v[d] = [], i = y ? Math.min(f, d) * b - 0.5 : m % f, n = y ? (d * w) / f - 0.5 : (m / f) | 0, l = z, u = h = 0; u < d; u++)
    ...
    function Ua(u, t) {
        var h,
            ...
            e = J(u);
        return (
            !e && r(u) && ((h = e = u.radius || z), u.values ? ((u = yt(u.values)), (l = !p(u[0])) && (h *= h)) : (u = Ta(u.increment))),
            Ja(
                t,
                e
                    ? o(u)
    ...
    function ab(t) {
        for (var e, r, i, n, a = 0, s = ""; ~(e = t.indexOf("random(", a)); )
            (i = t.indexOf(")", e)), (n = "[" === t.charAt(e + 7)), (r = t.substr(e + 7, i - e - 7).match(n ? nt : W)), (s += t.substr(a, e - a) + Va(n ? r : +r[0], +r[1], +r[2] || 1e-5)), (a = i + 1);
    ...
    function Ab(t, e) {
        for (var r, i = t._first; i; )
            i instanceof Rt ? Ab(i, e) : !i.vars.yoyoEase || (i._yoyo && i._repeat) || i._yoyo === e || (i.timeline ? Ab(i.timeline, e) : ((r = i._ease), (i._ease = i._yEase), (i._yEase = r), (i._yoyo = e))), (i = i._next);
    }
    function Cb(t, e, r, i) {
        void 0 === r &&
    ...
    function kk(e) {
        ...
        w < i && (k += i - x),
            (C += i),
            (T.time = (C - k) / 1e3),
            (0 < (t = T.time - P) || n) && (T.frame++, (P += t + (A <= t ? 0.004 : A - t)), (r = 1)),
            n || (g = v(kk)),
            r &&
    ...
    function Hl(t) {
        return t < F ? D * t * t : t < 0.7272727272727273 ? D * Math.pow(t - 1.5 / 2.75, 2) + 0.75 : t < 0.9090909090909092 ? D * (t -= 2.25 / 2.75) * t + 0.9375 : D * Math.pow(t - 2.625 / 2.75, 2) + 0.984375;
    }
    ...
    var Rt = (function (i) {
        ...
        return (
            ...
            (t.totalTime = function totalTime(t, e) {
                return arguments.length
                    ? ((this._forcing = 1), !this._dp && this._ts && (this._start = aa(Mt.time - (0 < this._ts ? t / this._ts : (this.totalDuration() - t) / -this._ts))), i.prototype.totalTime.call(this, t, e), (this._forcing = 0), this)
                    : this._tTime;
            }),
            ...
            (t.getTweensOf = function getTweensOf(t, e) {
                for (var r, i = [], n = yt(t), a = this._first, s = p(e); a; )
                    a instanceof Xt
                        ? ba(a._targets, n) && (s ? (!Lt || (a._initted && a._ts)) && a.globalTime(0) <= e && a.globalTime(a.totalDuration()) > e : !e || a.isActive()) && i.push(a)
                ...
                if (s._dirty) {
                    for (n = s.parent; o; )
                        (e = o._prev),
                            ...
                            u < (i = o._start) && s._sort && o._ts && !s._lock ? ((s._lock = 1), (Aa(s, o, i - o._delay, 1)._lock = 0)) : (u = i),
        ...
        Bt = function _addPropTween(t, e, r, i, a, s, u, h, l) {
            ...
            if ((n(i) && (~i.indexOf("random(") && (i = ab(i)), "=" === i.charAt(1) && (i = parseFloat(p) + parseFloat(i.substr(2)) * ("-" === i.charAt(0) ? -1 : 1) + (La(p) || 0))), p !== i))
                return isNaN(p * i)
                    ? (d || e in t || L(e, i),
                      function _addComplexStringPropTween(t, e, r, i, n, a, s) {
                          var o,
                              ...
                              m = 0,
                              g = 0;
                          for (_.b = r, _.e = i, r += "", (p = ~(i += "").indexOf("random(")) && (i = ab(i)), a && (a((c = [r, i]), t, e), (r = c[0]), (i = c[1])), u = r.match(et) || []; (o = et.exec(i)); )
                              (l = o[0]),
                    ...
                    : ((f = new ee(this._pt, t, e, +p || 0, i - (p || 0), "boolean" == typeof d ? Jt : Qt, 0, c)), l && (f.fp = l), u && f.modifier(u, this, t), (this._pt = f));
        },
        qt = function _initTween(t, e) {
            ...
            if ((!E || (M && g) || (g = "none"), (t._ease = Ft(g, R.ease)), (t._yEase = O ? Dt(Ft(!0 === O ? g : O, R.ease)) : 0), O && t._yoyo && !t._repeat && ((O = t._yEase), (t._yEase = t._ease), (t._ease = O)), !E)) {
                if (((c = (l = S[0] ? Z(S[0]).harness : 0) && m[l.prop]), (r = la(m, st)), P && P.render(-1, !0).kill(), v)) {
                    ...
                    if (P) C || (t._startAt = 0);
                    else if ((e && (y = !1), (n = ha({ overwrite: !1, data: "isFromStart", lazy: y && s(T), immediateRender: y, stagger: 0, parent: D }, r)), c && (n[l.prop] = c), qa((t._startAt = Xt.set(S, n))), y)) {
                        if (!e) return;
        ...
        Xt = (function (D) {
            function Tween(t, e, i, n) {
                ...
                if (((a._targets = S.length ? Y(S) : M("GSAP target " + t + " not found. https://greensock.com", !U.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = w), x || b || u(v) || u(y))) {
                    if (((e = a.vars), (o = a.timeline = new Rt({ data: "nested", defaults: k || {} })).kill(), (o.parent = _assertThisInitialized(a)), x))
                ...
                return (
                    !0 === w && ((Lt = _assertThisInitialized(a)), I.killTweensOf(S), (Lt = 0)),
                        ...
                        if (_ !== this._tTime || !t || r || (this._startAt && this._zTime < 0 != t < 0)) {
                            ...
                            (l && l.render(t < 0 ? t : !i && u ? -B : l._dur * h, e, r)) || (this._startAt && (this._zTime = t)),
                                ...
                                (_ !== this._tDur && _) ||
                                    ...
                                    e || (t < 0 && !d) || (!_ && !d) || (bt(this, _ === p ? "onComplete" : "onReverseComplete", !0), !this._prom || (_ < p && 0 < this.timeScale()) || this._prom()));
                        }
                    } else
                            ...
                            "all" !== e &&
                                ...
                                (e = (function _addAliasesToVars(t, e) {
                                    var r,
                                        ...
                                        o = s && s.aliases;
                                    if (!o) return e;
                                    for (i in ((r = ct({}, e)), o)) if ((i in r)) for (n = (a = o[i].split(",")).length; n--; ) r[a[n]] = r[i];
                                    return r;
                                })(f, e))),
                            l = f.length;
                        l--;
    ...
    _(
        ...
        (I = new Rt({ sortChildren: !1, defaults: R, autoRemoveChildren: !0, id: "root", smoothChildTiming: !0 })),
        (U.stringFilter = qb);
    var re = {
        ...
        exportRoot: function exportRoot(t, e) {
            ...
            var r,
                i,
                n = new Rt(t);
            for (n.smoothChildTiming = s(t.smoothChildTiming), I.remove(n), n._dp = 0, n._time = n._tTime = I._time, r = I._first; r; )
    ...
    function od(e) {
        ...
        return (r && (r.width || r.height)) || e.getBBox === md || (r = md.call(e, !0)), !r || r.width || r.x || r.y ? r : { x: +nd(e, ["x", "cx", "x1"]) || 0, y: +nd(e, ["y", "cy", "y1"]) || 0, width: 0, height: 0 };
    }
    function pd(t) {
    ...
    function ud(t, e, r, i) {
        ...
        return (
            ...
            Se[e] && "transform" !== e
                ? ((n = Ge(t, i)), (n = "transformOrigin" !== e ? n[e] : Qe(id(t, qe)) + " " + n.zOrigin + "px"))
                : ((n = t.style[e]) && "auto" !== n && !i && !~(n + "").indexOf("calc(")) || (n = (Ze[e] && Ze[e](t, e, r)) || id(t, e) || $(t, e) || ("opacity" === e ? 1 : 0)),
            ...
            for (; (o = tt.exec(i)); )
                (d = o[0]),
                    ...
                    d !== (f = u[T++] || "") &&
                        ...
                        m !== _ && (h = td(t, e, f, _) || 0),
                        (v._pt = { _next: v._pt, p: c || 1 === T ? c : ",", s: h, c: g ? g * p : p - h, m: l && l < 4 ? Math.round : 0 }));
    ...
    function yd(t, e) {
        if (e.tween && e.tween._time === e.tween._dur) {
            ...
            else for (n = (o = o.split(",")).length; -1 < --n; ) (r = o[n]), Se[r] && ((i = 1), (r = "transformOrigin" === r ? qe : Be)), qd(a, r);
    ...
    function Fd(t, e, r, i, n, a) {
        ...
        r
            ...
            : ((w = (s = od(t)).x + (~b[0].indexOf("%") ? (w / 100) * s.width : w)), (x = s.y + (~(b[1] || b[0]).indexOf("%") ? (x / 100) * s.height : x))),
            i || (!1 !== i && h.smooth) ? ((y = w - f), (T = x - d), (h.xOffset = p + (y * _ + T * g) - y), (h.yOffset = c + (y * m + T * v) - T)) : (h.xOffset = h.yOffset = 0),
            (h.xOrigin = w),
            (h.yOrigin = x),
            (h.smooth = !!i),
            (h.origin = e),
            ...
            (t.style[qe] = "0px 0px"),
            a && (rd(a, h, "xOrigin", f, w), rd(a, h, "yOrigin", d, x), rd(a, h, "xOffset", p, h.xOffset), rd(a, h, "yOffset", c, h.yOffset)),
    ...
    function Qd(t, e, r) {
        var i,
            ...
            l = he.style,
            f = r._gsap;
        for (n in ((l.cssText = getComputedStyle(r).cssText + ";position:absolute;display:block;"), (l[Be] = e), ae.body.appendChild(he), (i = Ge(he, 1)), Se))
            (a = f[n]) !== (s = i[n]) &&
                "perspective,force3D,transformOrigin,svgOrigin".indexOf(n) < 0 &&
                ((o = La(a) !== (h = La(s)) ? td(r, n, a, h) : parseFloat(a)), (u = parseFloat(s)), (t._pt = new ee(t._pt, f, n, o, u - o, Uc)), (t._pt.u = h || 0), t._props.push(n));
    ...
    var ne,
        ...
        Ge = function _parseTransform(t, e) {
            ...
            return (
                ...
                (r.svg = !(!t.getCTM || !pd(t))),
                (m = Ed(t, r.svg)),
                r.svg && ((M = !r.uncache && t.getAttribute("data-svg-origin")), Fd(t, M || B, !!M || r.originIsAbsolute, !1 !== r.smooth, m)),
                (c = r.xOrigin || 0),
                (_ = r.yOrigin || 0),
                m !== Ve &&
                    ((T = m[0]),
                    ...
                    6 === m.length
                        ...
                        : ((E = m[6]),
                          ...
                          g &&
                              ...
                              (E = A)),
                          (l = (g = ze(-w, D)) * De),
                          g && ((v = Math.cos(-g)), (z = x * (y = Math.sin(-g)) + z * v), (T = M = T * v - P * y), (b = C = b * v - S * y), (w = A = w * v - D * y)),
                          (u = (g = ze(b, T)) * De),
                          ...
                          (p = z ? 1 / (z < 0 ? -z : z) : 0)),
                    r.svg && ((M = t.getAttribute("transform")), (r.forceCSS = t.setAttribute("transform", "") || !Cd(id(t, Be))), M && t.setAttribute("transform", M))),
            ...
            (d = parseFloat(d)),
                ...
                d || p
                    ? ((d *= Fe),
                      ...
                      (n = Math.sin(d - p) * -m),
                      (a = Math.cos(d - p) * m),
                      p && ((c *= Fe), (s = Math.tan(p - c)), (n *= s = Math.sqrt(1 + s * s)), (a *= s), c && ((s = Math.tan(c)), (r *= s = Math.sqrt(1 + s * s)), (i *= s))),
                      (r = aa(r)),
                      (i = aa(i)),
                      (n = aa(n)),
                      (a = aa(a)))
                    : ((r = _), (a = m), (i = n = 0)),
                ((x && !~(l + "").indexOf("px")) || (k && !~(f + "").indexOf("px"))) && ((x = td(g, "x", l, "px")), (k = td(g, "y", f, "px"))),
                    ...
                    if ("autoRound" !== f && ((s = e[f]), !ht[f] || !Mb(f, e, r, i, t, n)))
                        if (((h = typeof s), (l = Ze[f]), "function" === h && (h = typeof (s = s.call(r, i, t, n))), "string" === h && ~s.indexOf("random(") && (s = ab(s)), l)) l(this, t, f, s, r) && (y = 1);
                            ...
                            if (
                                ...
                                (o = parseFloat(s)),
                                f in Le &&
                                    ("autoAlpha" === f && (1 === u && "hidden" === ud(t, "visibility") && o && (u = 0), rd(this, b, "visibility", u ? "inherit" : "hidden", o ? "inherit" : "hidden", !o)),
                                    "scale" !== f && "transform" !== f && ~(f = Le[f]).indexOf(",") && (f = f.split(",")[0])),
                                (_ = f in Se))
                            )
                                if ((m || ((g = t._gsap).renderTransform || Ge(t), (v = !1 !== e.smoothOrigin && g.smooth), ((m = this._pt = new ee(this._pt, b, Be, 0, 1, g.renderTransform, g, 0, -1)).dep = 1)), "scale" === f))
                                    (this._pt = new ee(this._pt, g, "scaleY", g.scaleY, c ? c * o : o - g.scaleY)), T.push("scaleY", f), (f += "X");
                                else {
